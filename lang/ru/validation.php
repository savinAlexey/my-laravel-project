...
return [
    ...
    | например правила размера. Вы можете свободно изменять эти сообщения.
    |
    */
    ...
    | быстро указать конкретное пользовательское сообщение для данного правила.
    |
    */
    ...
    | на что-то более удобочитаемое, например "Email адрес" вместо
